...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Fijicare.Droid.StepCounter, Fijicare.Android", StepCounter.class, __md_methods);
	}
	...
	public StepCounter ()
	{
		...
		if (getClass () == StepCounter.class) {
			mono.android.TypeManager.Activate ("Fijicare.Droid.StepCounter, Fijicare.Android", "", this, new java.lang.Object[] {  });
		}
	}
