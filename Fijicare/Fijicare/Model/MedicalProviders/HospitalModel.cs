...
namespace Fijicare.Model.MedicalProviders
{
    ...
    public class MedicalProvidersObj : Fijicare.Model.ModelBase
    {
        ...
        {
            public List<MedicalProvidersObj> MedicalProvidersObj { get; set; }
        }
